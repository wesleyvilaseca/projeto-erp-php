                ...
                <div class="col-12">
                    <div class="caixa">
                            ...
                            <div id="tab-1" class="tab-content current">
                                ...
                                <div class="rows pb-4">										
                                    ...
                                    <div class="col-4 mb-3">
                                        ...
                                        <input type="date" name="data_cadastro" value="<?php echo (isset($contato)) ? $contato->data : null ?>" placeholder="Digite aqui..." class="form-campo">
                                    </div>	
                                    ...
                                    <div class="col-2">
                                        ...
                                        <select class="form-campo" name="ativo">
                                            <option value="S" <?php echo (!isset($contato)) ? "" : ($cliente->ativo_cliente == "S") ? "selected" : null ?>>Sim</option>                                                 
                                            <option value="N" <?php echo (!isset($contato)) ? "" : ($cliente->ativo_cliente == "N") ? "selected" : null ?>>Não</option> 
                                        </select>
                                    </div>
                                        ...
                                        <select class="form-campo" name="id_cidade">
                                            ...
                                            if ($estado->id_estado) {
                                                foreach ($cidades as $cidade) {
                                                    //$cidades = (!isset($estado->id_estado)) ? "" : ($cidade->id_cidade == $estado->id_estado) ? $cidade->nome_cidade : "";
                        ...
                        <div class="mb-5" style="clear:both">                            
                            <a href="<?php echo URL_BASE . "contato/excluir/" . $contato->id_contato ?>" class="btn btn-verde btn-medio d-block m-auto">Excluir Contato</a>
                        </div>
                    </div>
