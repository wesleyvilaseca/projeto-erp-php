...
class Saida extends Model {
    ...
    public function filtroE($pesquisa, $inicio, $lpp) {
        $complemento = "";
     ...
     public function getTotalE($pesquisa, $inicio, $lpp) {
        $complemento = "";
    ...
    public function fazer_atendimento($id_item, $qtd){
        $sql = "update item set qtde_atendido   = :qtd, "
                . "atendido                     = 'S' "
                . "where id_item                = :id_item";
        
        $qry = $this->db->prepare($sql);
        $qry->bindValue(":qtd", $qtd);
        $qry->bindValue(":id_item", $id_item);
        $qry->execute();
    }
